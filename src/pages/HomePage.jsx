...
export default function HomePage() {
  return (
    <div className="homepage-shell min-h-screen max-w-full overflow-x-hidden bg-[rgba(255,255,255,0.2)] font-sans text-zinc-900">
      ...
      <main className="mx-auto mt-2 flex w-full min-w-0 max-w-360 flex-col gap-10 sm:mt-3 sm:px-4 sm:pb-7 md:my-5 md:gap-0 md:px-6 md:pb-5 lg:px-8 xl:px-10">
        <ScrollReveal delay={90} className="w-full min-w-0 px-3">
          <HeroSection />
        </ScrollReveal>
        <SectionSuspense>
          <ScrollReveal delay={160} className="min-w-0 w-full px-3">
