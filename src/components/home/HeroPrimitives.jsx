...
const PLAY_STORE_URL =
  "https://play.google.com/store/apps/details?id=com.stylemezuri.app";
const IOS_APP_URL = "https://testflight.apple.com/join/qhAcF9Ap";

export function StoreBadge({ apple = false, mobile = false, className = "" }) {
  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col leading-tight">
        ...
        <span
          className={
            mobile ? "text-[0.78rem] font-medium" : "text-[0.76rem] font-medium"
          }
        >
          {main}
        </span>
